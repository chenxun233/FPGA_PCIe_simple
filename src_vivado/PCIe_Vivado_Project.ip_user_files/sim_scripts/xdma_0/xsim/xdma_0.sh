...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L blk_mem_gen_v8_4_2 -L fifo_generator_v13_1_4 -L xdma_v4_1_2 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xdma_0 xil_defaultlib.xdma_0 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/chenxun/Software/Vivado/Vivado/2018.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
